      ...
      <div className="px-6 py-24 sm:px-6 sm:py-32 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mx-auto mt-6 max-w-xl text-lg/8 text-pretty text-gray-600">
            Karavela is recruiting healthy volunteers to participate in a large brain MRI trial. Learn more about your brain while contributing to important research by joining <span className="underline decoration-1 decoration-dotted underline-offset-4 italic decoration-gray-800">Cephalonauts One</span>, our first clinical trial.
          </p>
          <div className="mt-10 flex items-center justify-center gap-x-6">
            <a
              href="#"
